...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        LGActionSheet *actionSheet = [[LGActionSheet alloc] initWithTitle:@"Text Font size settings"
                                                             buttonTitles:@[@"Large",@"Medium",@"Small"]
                                                        cancelButtonTitle:@"Cancel"
                                                   destructiveButtonTitle:nil
                                                            actionHandler:nil
                                                            cancelHandler:nil
        ...
        actionSheet.buttonsFonts = @[font30,
                                     font20,
                                     font17
                                     ];
        actionSheet.tintColor = [UIColor lightGrayColor];
        actionSheet.buttonsTitleColorHighlighted = [UIColor redColor];
        actionSheet.cancelButtonTitleColorHighlighted = [UIColor redColor];
        [actionSheet showAnimated:YES completionHandler:nil];
    }
